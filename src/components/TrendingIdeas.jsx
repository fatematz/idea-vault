        ...
        <div className="bg-slate-50/50 min-h-screen">
            ...
            <div className="max-w-[1450px] mx-auto px-6 py-20">
                ...
                <div className="mb-12 text-center sm:text-left">
                    ...
                    <div className="border-b border-slate-200/60 w-full mt-6"></div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {trendingIdeas.map((idea) => (
                        <div 
                            key={idea._id} 
                            className="bg-white border border-slate-200/60 rounded-2xl p-5 flex flex-col justify-between shadow-sm hover:shadow-md hover:border-slate-300 transition-all duration-200"
                        >
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    <h3 className="text-[20px] font-bold text-slate-950 tracking-tight leading-snug line-clamp-2 min-h-[56px]">
                                        {idea.title}
                                    </h3>
                                    <p className="text-slate-600 text-[18px] leading-relaxed line-clamp-2 min-h-[54px]">
                                        {idea.shortDescription}
                                    </p>
                                </div>

                                {idea.budget && (
                                    <p className="text-[18px] font-extrabold text-emerald-700">
                            ...
                            <div className="mt-6 pt-4 border-t border-slate-100 space-y-4">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-slate-700 text-[18px] font-medium truncate max-w-[180px]">
