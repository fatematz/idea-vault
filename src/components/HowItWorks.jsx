  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-[1300px] mx-auto px-6 text-center">
        <h2 className="text-3xl font-extrabold text-slate-950 mb-12">How It Works</h2>
        ...
        <div className="flex flex-wrap justify-center gap-8">
          {steps.map((step, i) => (
            <div 
              key={i} 
              className="flex-1 min-w-[280px] max-w-[400px] p-8 border border-slate-100 rounded-3xl bg-slate-50 transition-all hover:shadow-lg"
            >
