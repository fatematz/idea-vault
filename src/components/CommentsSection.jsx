          ...
          <div className="space-y-4 mb-8 max-h-[350px] overflow-y-auto pr-2">
            {comments.map((comment, index) => (
              <div
                ...
                className="bg-slate-50 p-4 rounded-xl border border-slate-100 flex gap-3 items-start"
              >
                <img
                ...
                <div className="space-y-1 w-full">
                  <div className="flex items-center justify-between">
                    <span className="font-bold text-[20px] text-slate-800">
        ...
        <form onSubmit={handlePostComment} className="space-y-4">
          <div className="flex gap-3 items-start">
            <img
              ...
              className="w-10 h-10 rounded-full object-cover border border-slate-200 mt-2"
            />
            <div className="w-full">
              <textarea
                ...
                rows="3"
                className="w-full p-4 rounded-xl border border-slate-200 bg-white focus:outline-none focus:ring-2 focus:ring-[#C6D62E]/30 focus:border-[#C6D62E] transition-all text-slate-800 shadow-sm resize-none"
              />
            </div>
          </div>
          ...
          <div className="flex justify-end">
            <button
              ...
              className="bg-[#C6D62E] hover:bg-[#C6D62E] disabled:bg-slate-300 text-black font-bold text-sm px-6 py-2.5 rounded-xl transition-colors shadow-sm cursor-pointer"
            >
              Post Comment
            </button>
          </div>
